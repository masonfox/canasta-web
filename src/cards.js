 ...
 */
const cards = {
    1: { id: 1, name: 'Jack', abbreviation: 'J', value: 50, valid: { canasta: false, loose: true, remaining: true } },
    ...
    6: { id: 6, name: 'Jack', abbreviation: 'J', value: 10, valid: { canasta: true, loose: true, remaining: true }  },
